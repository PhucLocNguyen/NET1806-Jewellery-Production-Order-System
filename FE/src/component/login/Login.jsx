                ...
                >
                    <form className='bg-[#fff] flex items-center justify-center flex-col h-[100%] px-[40px]'>
                        ...
                        <div className='my-[10px]'>
                            <motion.a whileHover={{scale:1.3}} href='#' className='border-[2px] border-solid border-[#ccc] rounded-[20%] inline-flex justify-center items-center mx-[4px] w-[40px] h-[40px]'>
                                <SvgIcon>
